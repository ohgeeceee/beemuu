...
const DEFAULT_SITE_CONFIG = {
  ...
  // (https://ohgeeceee.github.io/beemuu/) and a custom domain from the apex
  // (https://beemuu.com/). scripts/build-github-pages.cjs generates
  // site-config.js with the value that matches the published artifact, so
  // runtime fetches resolve in both shapes.
  basePath: "/",
  apiBaseUrl: "",
...
async function loadReleaseInfo() {
  ...
  try {
    const response = await fetch(joinUrl(siteConfig.basePath, "_release_info.json"), { cache: "no-store" });
