...
const EN = {
  ...
  cbs_timeline: "Service timeline (Predictive CBS)",
  cbs_sub: "When will each service item actually be due?",
...
const DE = {
  ...
  cbs_timeline: "Service-Timeline (Predictive CBS)",
  cbs_sub: "Wann ist jeder Servicepunkt tatsächlich fällig?",
...
const FR = {
  ...
  cbs_timeline: "Chronologie d'entretien (CBS prédictif)",
  cbs_sub: "Quand chaque élément d'entretien sera-t-il réellement dû ?",
